...
namespace utility {
    ...
    public:
        ...
        std::vector<int> vectorInt_;
        std::vector<std::string> vectorString_;
    };
    ...
    public:
        ...
        explicit Enumerate(std::vector<std::string> vectorString);
        std::unique_ptr<IterableIterator> ConstBegin() const override;
        std::unique_ptr<IterableIterator> ConstEnd() const override;
    };
    ...
    public:
        ...
        Product(std::vector<int> vectorInt, std::vector<std::string> vs);
        std::unique_ptr<IterableIterator> ConstBegin() const override;
        std::unique_ptr<IterableIterator> ConstEnd() const override;
    };
}
